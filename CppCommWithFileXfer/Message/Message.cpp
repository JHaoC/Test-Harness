...
//----< get path Attribute >-----------
std::string MsgPassingCommunication::Message::path()
{
	if (containsKey("path"))
	{
		return attributes_["path"];
	}
	return "";
}

//----< Set path Attribute >-----------
void MsgPassingCommunication::Message::path(const std::string & path)
{
	attributes_["path"] = path;
}

//----< get types Attribute >-----------
std::string MsgPassingCommunication::Message::types()
{
	if (containsKey("types"))
	{
		return attributes_["types"];
	}
	return "";
}

//----< Set types Attribute >-----------
void MsgPassingCommunication::Message::types(const std::string & type)
{
	attributes_["types"] = type;
}

//----< get testRequest Attribute >-----------
std::string MsgPassingCommunication::Message::testRequest()
{
	if (containsKey("testRequest"))
	{
		return attributes_["testRequest"];
	}
	return "";
}

//----< Set testRequest Attribute >-----------
void MsgPassingCommunication::Message::testRequest(const std::string & tr)
{
	attributes_["testRequest"] = tr;
}
