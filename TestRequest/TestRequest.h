...
// ver 1.0                                                           //
// Junhao Chen                                                       //
// Original: Jim Fawcett, CSE687 - Object Oriented Design, Fall 2018 // 
///////////////////////////////////////////////////////////////////////
/*
*  Package Operations:
*  -------------------
...
*  --------------------
*  ver 1.0 : 6 Nov 2018
*  - Modify from Jim Fawcett
*  - proving method to messages' string which can be read as message
*  - proving method to transfer to testrequest from messages' string
*/
